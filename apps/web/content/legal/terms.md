...
services (collectively, the "Service"), operated by Talysman ("Talysman", "we",
"us", or "our"). By creating an account or using the Service, you agree to these
Terms. If you do not agree, do not use the Service.

## The short version

- You pay us, and we give you access to the Service.
- You own your data; we process it to provide the Service, as described in our
  [Privacy Policy](/privacy).
- Either of us can end the relationship with reasonable notice.

## Eligibility and accounts

You must be at least 13 years old (or the minimum age required in your
jurisdiction) to use the Service. You are responsible for the accuracy of the
information you provide, for maintaining the security of your account credentials,
and for all activity that occurs under your account. Notify us promptly at
[support@talysman.app](mailto:support@talysman.app) if you suspect unauthorized use
of your account.

## Subscriptions, billing, and refunds

Certain features of the Service require a paid subscription. Payments are processed
by our payment provider, Stripe. By subscribing, you authorize us to charge the
...
- **Cancellation.** You may cancel at any time through your account settings.
  ...
  access until then.
- **Price changes.** We may change our fees from time to time. We will give you
  reasonable advance notice of any price change, which will apply to the next
  billing period.
- **Refunds.** Except where required by law, fees are non-refundable. If you believe
...
- resell, sublicense, or commercially exploit the Service without our permission;
  or
- use the Service to transmit malware or to engage in abusive, fraudulent, or
  harmful activity.
...
You retain ownership of the data and content you provide to the Service ("Your
Content"). You grant us a limited license to host, process, and use Your Content
solely as needed to operate and provide the Service. Our handling of personal
information is described in our [Privacy Policy](/privacy).

## Intellectual property

The Service, including its software, design, and content we provide, is owned by
Talysman and protected by intellectual property laws. Subject to these Terms, we
grant you a limited, non-exclusive, non-transferable, revocable license to use the
Service for its intended purpose. We reserve all rights not expressly granted.

## Third-party services

The Service integrates with third-party providers, such as Stripe for payments and
authentication providers for sign-in. Your use of those services may be subject to
their own terms and policies, and we are not responsible for third-party services.
...
To the fullest extent permitted by law, Talysman and its affiliates will not be
liable for any indirect, incidental, special, consequential, or punitive damages, or
for any loss of profits, data, or goodwill, arising out of or related to your use of
the Service. Our total liability for any claim arising out of or relating to these
Terms or the Service will not exceed the amount you paid us in the twelve months
...
terminate your access if you breach these Terms or if we discontinue the Service.
Upon termination, your right to use the Service ends, and provisions that by their
nature should survive termination will remain in effect.

## Changes to these Terms

We may update these Terms from time to time. When we make material changes, we will
update the date at the top of this page and, where appropriate, provide additional
...
Talysman is established, without regard to conflict-of-law principles. Any disputes
will be subject to the exclusive jurisdiction of the courts located there, unless
