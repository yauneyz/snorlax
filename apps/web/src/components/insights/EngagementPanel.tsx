...
export async function EngagementPanel({
  ...
  return (
    <PanelShell
      ...
      description="Latest reported day, split by how focus began."
    >
      {!result.ok ? (
        ...
        <div className="insights-kpis">
          <div>
            <span>Median focus</span>
            <strong>{data.medianFocusMinutes}m</strong>
          </div>
          <div>
            <span>Scheduled</span>
            <strong>{data.scheduledFocusHours}h</strong>
          </div>
          <div>
            <span>Manual</span>
            <strong>{data.manualFocusHours}h</strong>
          </div>
          <div>
            <span>Completed / aborted</span>
            <strong>
              {data.sessionsCompleted} / {data.sessionsAborted}
            </strong>
          </div>
        </div>
      )}
