...
/**
 * The landing page body, shared between the real `/` route and the dev-only `/<variant-id>`
 * preview route ([slug]/page.tsx) so the two never drift. `variantOverride` forces HeroCopy to a
 * specific variant instead of reading the live PostHog flag — used only by that preview route.
 */
export function LandingPage({ variantOverride }: { variantOverride?: VariantKey } = {}) {
  return (
    <>
      <section className="hero">
        <div className="hero__copy">
          <HeroCopy forceVariant={variantOverride} />
