...
pub(crate) const RUNTIME_CONFIG_PATH: &str = "/run/focuslock/dnsmasq.conf";
pub(crate) const DNSMASQ_INCLUDE_PATH: &str = "/etc/dnsmasq.d/focuslock.conf";
...
/// Write the permanent dnsmasq include that points at FocusLock's runtime config. This is best
...
pub fn install_include() -> std::io::Result<()> {
    ...
    std::fs::write(
        ...
        format!(
            "# FocusLock DNS sinkhole include. Generated by focuslock-svcctl.\nconf-file={RUNTIME_CONFIG_PATH}\n"
        ),
    )
}
...
fn dnsmasq_config(policy: &Policy) -> String {
    let mut out = String::from(
        "# FocusLock DNS sinkhole configuration.\n# Auto-generated; do not edit manually.\n\n",
    );
